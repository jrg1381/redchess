...
namespace EngineTests
{
    ...
    class Datastructures
    {
        ...
        public void SquaresCompareCorrectly(Location firstLocation, Location secondLocation, bool expected)
        {
            ...
            Assert.That((firstSquare == secondSquare) == expected, "Expected squares to compare equal");
            Assert.That((firstSquare != secondSquare) == !expected, "Expected squares to compare as different");
        }
