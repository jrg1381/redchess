...
namespace RedChess.WebEngine.Repositories.Interfaces
{
    public interface IGameManager
    {
        ...
        bool Move(int id, Location startLocation, Location endLocation, string promoteTo, DateTime moveReceivedAt, out GameDto gameDto);
        ...
        bool UserIsAdministrator(int userId);
