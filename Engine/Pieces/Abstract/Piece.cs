...
namespace Redchess.Engine.Pieces.Abstract
{
    internal abstract class Piece : IPiece
    {
        ...
        protected internal IEnumerable<Location> ReachableSquares(IEnumerable<Tuple<int,int>> moveSet, IBoardExtended game)
        {
            ...
            foreach (var moveVector in moveSet)
            {
                ...
                {
                    generatedSquare = new Square(generatedSquare.X + moveVector.Item1, generatedSquare.Y + moveVector.Item2);
